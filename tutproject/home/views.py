...
def index(request):
    if request.method == 'POST':
        ...
        plt.pie(sentiment_counts, labels=['Positive', 'Non-Positive', 'Neutral'], colors=['green', 'red', 'yellow'],
        ...
        return render(request, 'index.html', {'plot_image': plot_image, 'senti': sentiment_counts})

    return render(request, 'index.html') 
        #  return render_template('index.html', plot_image=plot_image , senti = sentiment_counts )
